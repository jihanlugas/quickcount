                        ...
                        <div class="relative w-full">
                            <select
                                ...
                                @foreach($mPeroids as $mPeroid)
                                    <option
                                        value="{{ $mPeroid->id }}" {{ $mElection->start == $mPeroid->id ? "selected" : ""}}>{{ $mPeroid->name }}</option>
                                @endforeach
                            </select>
                            <div
                    ...
                    <div class="w-full sm:w-1/2 px-2 mb-6">
                        ...
                        <div class="relative w-full">
                            <select
                                ...
                                @foreach($mPeroids as $mPeroid)
                                    <option
                                        value="{{ $mPeroid->id }}" {{ $mElection->end == $mPeroid->id ? "selected" : ""}}>{{ $mPeroid->name }}</option>
                                @endforeach
                            </select>
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                    ...
                    <div class="relative w-full">
                        <select
                            ...
                            @foreach($mPositions as $mPosition)
                                <option
                                    value="{{ $mPosition->id }}" {{ $mElection->position_id == $mPosition->id ? "selected" : ""}}>{{ $mPosition->name }}</option>
                            @endforeach
                        </select>
                        <div
                            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
